...
<body>
	<header class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="container">
			<a
				href="?lang=en&computerId=${ editAttributes.computer.id }&firstCall=${ editAttributes.firstCall }">EN</a>&nbsp;
			<a
				href="?lang=fr&computerId=${ editAttributes.computer.id }&firstCall=${ editAttributes.firstCall }">FR</a>
		</div>
	</header>
	<section id="main">
		<div class="container">
