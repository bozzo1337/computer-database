				...
				<div class="pull-left">
					<form id="searchForm" action="" method="GET" class="form-inline">
						...
						<input type="search" id="searchbox" name="search"
							class="form-control" 
							<c:choose>
								<c:when test="${ not empty dashboardAttributes.search }">value="${ dashboardAttributes.search }"</c:when>
								<c:otherwise>placeholder="<spring:message code="searchField"/>"</c:otherwise>
							</c:choose> />
